    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <form action="{{ route('trips.store') }}" method="POST" class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="destination" id="destination" placeholder="City, Country" 
                               ...
                               value="{{ request('destination', old('destination')) }}" required>
                    </div>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="What are your goals for this trip?" 
                              class="w-full px-5 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-party-1 transition-all outline-none">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-100">
                ...
                <button type="submit" class="btn-primary py-3 px-10 rounded-xl text-page-text font-bold shadow-lg shadow-party-1/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
                    Create Trip
                </button>
            </div>
        </form>
