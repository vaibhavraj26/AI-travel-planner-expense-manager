...
<div class="max-w-7xl mx-auto space-y-8 animate-float-up">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold text-page-text font-['Playfair_Display',serif]">Your Adventures</h1>
            <p class="text-slate-500 mt-1">Manage and plan your upcoming journeys with ease.</p>
        </div>
        <div>
            <a href="{{ route('trips.create') }}" class="btn-primary py-3 px-6 rounded-xl text-page-text font-bold text-sm shadow-lg shadow-party-1/20 hover:-translate-y-1 transition-all inline-flex items-center gap-2">
