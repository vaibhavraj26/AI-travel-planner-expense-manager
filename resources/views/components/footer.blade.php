<footer class="bg-[#040811] text-white py-10 border-t border-slate-800 font-['Sora',sans-serif] relative z-10 mt-auto">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-[#1A2540] to-page-text rounded-2xl p-6 lg:p-8 mb-10 border border-[#FFB800]/20 relative overflow-hidden shadow-2xl shadow-black/50">
             ...
             <div class="relative z-10 flex-shrink-0">
                 <a href="{{ route('register', ['plan' => 'free']) }}" class="btn-primary inline-flex items-center gap-2 px-6 py-3 rounded-full text-page-text font-bold text-sm btn-glow transition-transform">
                    Get Started Free
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Features</a></li>
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Pricing</a></li>
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Destinations</a></li>
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Integration</a></li>
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">Changelog <span class="ml-2 inline-block bg-accent/20 text-accent text-[10px] font-bold px-2 py-0.5 rounded-full">NEW</span></a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-slate-400 hover:text-white transition-colors text-sm">About Us</a></li>
            ...
            <div class="lg:col-span-1">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded-full bg-party-1/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <svg class="w-4 h-4 text-party-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </div>
                        <address class="text-slate-400 text-sm leading-relaxed">Punjab, India<br>Phagwara, PIN: 144411</address>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:5860vaibhav@gmail.com" class="text-slate-400 hover:text-white transition-colors text-sm font-medium">5860vaibhav@gmail.com</a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+919708681252" class="text-slate-400 hover:text-white transition-colors text-sm font-medium">+91 9708681252</a>
                    </li>
                </ul>
            </div>
        </div>
