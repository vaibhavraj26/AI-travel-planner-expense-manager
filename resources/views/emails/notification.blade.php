        ...
        <div style="background:white;border-radius:24px;padding:32px;border:1px solid #e2e8f0;box-shadow:0 10px 30px rgba(15,23,42,.08);">
            ...
            @if($actionLabel && $actionUrl)
                <div style="margin:0 0 8px;">
                    <a href="{{ $actionUrl }}" style="display:inline-block;background:#f97316;color:white;text-decoration:none;font-weight:700;border-radius:14px;padding:14px 22px;">{{ $actionLabel }}</a>
                </div>
            @endif
        </div>
    </div>
